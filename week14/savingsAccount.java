...
public class savingsAccount extends Account implements Writable {
    ...
    public savingsAccount(int accountNumber, Employee manager, Customer owner, Date created, double interes, double yearlyDepositeLimit, double withdrawalLimit, int withdrawals){
        super( accountNumber,manager, owner, created);
        this.yearlyDepositLimit = yearlyDepositeLimit;
        this.withdrawalLimit = withdrawalLimit;
        this.withdrawals = withdrawals;
    }

    /*another overloaded construtor */
    public savingsAccount(int accountNumber, Customer owner, Date created, double balance, double interest, double yearlyDepositeLimit, double withdrawalLimit, int withdrawals){
    ...
    public void update(){
        ...
        if (getBalance() < minBalance){ // if it is below the minimum.. 
            try{
                ...
                System.out.println("\t\t\tBALANCE BELOW MINIMUM. PENALIZATION FOR YOU!!");
                penalize();
    ...
    public void write() throws IOException{
        ...
        String invoice = "SA" + first2OfFirst + first2OfLast + month + day + year;// create the invoice
