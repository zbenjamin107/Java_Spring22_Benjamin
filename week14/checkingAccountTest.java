...
public class checkingAccountTest {
    ...
    checkingAccount ca1 = new checkingAccount(123,c1,new Date(1,1,2022), 100000.00, 30000.00,50.00);
    checkingAccount ca2 = new checkingAccount(456,c2, new Date(10,10,2021),-30000.00,20000.00,50.00);
    checkingAccount copy1 = new checkingAccount(123,c1,new Date(1,1,2022), 100000.00, 30000.00,50.00);
